...
(* OASIS_START *)
(* DO NOT EDIT (digest: b1568fdb465aa9b0d4637b012175b4fa) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources =
                        ["porter2_c.c"; "porter2_c.h"; "porter2_stubs.c"];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\237\2179\135\b\180\190\208!\025\140!W}\021\255";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;

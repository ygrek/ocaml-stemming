...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0993f8fc870c00c799a1f4595177085d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = None;
          copyrights = ["(C) 2009 ygrek"; "(C) 2013 Mykola Stryebkov"];
          maintainers = [];
          authors = ["ygrek"; "Mykola Stryebkov"];
          homepage = Some "https://github.com/ygrek/ocaml-stemming";
          synopsis = "Stemming wrappers";
          description =
            Some
              "Wrappers for stemming algorithms, namely: Porter2 (English) and Keva (Russian and Ukrainian).";
          categories = [];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for ocaml-stemming";
                      doc_authors = ["ygrek"];
                      doc_abstract = None;
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "ssh://git@github.com/ygrek/ocaml-stemming.git";
                      src_repo_browser =
                        Some "https://github.com/ygrek/ocaml-stemming";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "M\169\176\184\025\132G\200aUq\245\024\172\251\167";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
